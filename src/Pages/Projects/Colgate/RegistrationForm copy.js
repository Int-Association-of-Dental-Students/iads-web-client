...
const ColgateForm = () => {
  ...
  if (logoFile.files[0].size > 500000) {
    alert("Logo image file size should not exceed 500Kb");
  }
  ...
  return (
    <>
      <form className="form container py-5" onSubmit={handleSubmit(onSubmit)}>
        <div className="row">
          {/* ////////////////////////////////////////////////////////////////////////////////////////// */}
          <div className="col coll">
            ...
            <div className="file-upload" for="custom-file">
              <label className="flexx">Upload your Association Logo</label>
              <input id="custom-file" name="file" type="file" />
            </div>
          </div>
          {/* ////////////////////////////////////////////////////////////////////////////////////////// */}
          <div className="col coll">
            ...
            <div className="row">
              <div className="flexx">
                ...
                <input
                  style={{ marginLeft: "10px" }}
                  {...register("Are you in good standing for the year 2022?", {
                    required: true,
                  })}
                  type="radio"
                  value=" No"
        ...
        <div className="row">
          <div className="flexx">
            ...
            <label htmlFor="disclosure">
              I shall not disclose any confidential information related to this
        ...
        <div className="row" style={{}}>
          <div className="flexx">
            ...
            <label htmlFor="permission">
              ...
              pertaining to this project elsewhere unless a prior permission is
              granted.
            </label>
          </div>
        </div>
